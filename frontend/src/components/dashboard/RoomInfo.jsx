...
function RoomInfo() {
    ...
    return (
        <div className="room-info-container glass-panel">
            <h3 className="section-title">{t('dashboard.room_info_title')}</h3>
            ...
            <div className="usage-limits">
                <h4>{t('dashboard.usage_limits')}</h4>
                <div className="limit-row">
                    <span className="limit-label">{t('dashboard.electric_tier1')}</span>
                    <span className="limit-value">50 kWh</span>
                </div>
                <div className="limit-row">
                    <span className="limit-label">{t('dashboard.water_quota')}</span>
                    <span className="limit-value">{t('dashboard.water_quota_unit')}</span>
                </div>
            </div>
        </div>
    );
